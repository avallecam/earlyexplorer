...
#' 2. modify one line #26: Replace `"gender"` by `"age_group"`. How this affects the code downstream?
#' 3. modify one line #27: Replace `"day"` by `"epiweek"`. How this affects the code downstream?
#' 4. modify one line #35: Block `fill = "gender"`. How this affects the code downstream?
